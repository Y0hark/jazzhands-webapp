    ...
    <v-expansion-panels v-model="panel">
      <v-expansion-panel>
        ...
        <v-expansion-panel-content>
          ...
          <ul>
            <li>
              Your Miracle scores: your best performance (displayed on you
              profile)
            </li>
            <li>Your Desolated Lands scores (also on your profile)</li>
          ...
          <ul>
            ...
            <li>
              For Desolated Lands: no need to speed things up, improving your
              score should be the only focus
            </li>
            <li>For Point War: easy right? just aim for higher rank!</li>
            <li>
              For Sentinel Hunt: improve your score as we don't take the time
              you take into consideration.
            </li>
          </ul>
          <br />
          Need help for this? Anytime you can ask the team to help you out!
          We'll be happy yo provide help and advice.<br />

          <b>Important note:</b> this is not a race. This is simply a number to
          help you out tracking you own progress.
        </v-expansion-panel-content>
      </v-expansion-panel>
    </v-expansion-panels>
    <br />
